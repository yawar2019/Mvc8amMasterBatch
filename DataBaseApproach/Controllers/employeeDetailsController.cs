...
namespace DataBaseApproach.Controllers
{
    public class employeeDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId")] employeeDetail employeeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId")] employeeDetail employeeDetail)
        {
            if (ModelState.IsValid)
            {
